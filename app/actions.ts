...
export async function updateInventoryQuantity(productId: number, quantity: number, notes = "") {
  try {
    const supabase = createServerClient()
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при оновленні кількості на складі" }
    }
  } catch (error) {
...
export async function shipInventory(formData: FormData) {
  try {
    ...
    if (!productId || isNaN(quantity) || quantity <= 0) {
      return { success: false, error: "Необхідно вказати продукт та кількість більше нуля" }
    }
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при відвантаженні продукції" }
    }
  } catch (error) {
...
export async function updateProduction(formData: FormData) {
  try {
    ...
    if (!shiftId || !productId || isNaN(quantity)) {
      return { success: false, error: "Необхідно вказати зміну, продукт та кількість" }
    }
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при оновленні виробництва" }
    }
  } catch (error) {
...
export async function getProducts(): Promise<Product[]> {
  try {
    ...
    const { data, error } = await supabase.from("products").select("*, category:product_categories(*)").order("name")
  ...
  try {
    ...
    try {
      const { data: productionData, error: productionError } = await supabase
        .from("production")
        .select("quantity, product:products(category_id, product_categories(name))")
      ...
      productionData.forEach((item) => {
        ...
        productionByCategory[categoryName] = (productionByCategory[categoryName] || 0) + item.quantity
      })
...
export async function addEmployeeToShift(formData: FormData) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при додаванні працівника" }
    }
  } catch (error) {
...
export async function createProductCategory(formData: FormData) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при створенні категорії" }
    }
  } catch (error) {
...
export async function completeShift(shiftId: number) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при завершенні зміни" }
    }
  } catch (error) {
...
export async function createShift(formData: FormData) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при створенні зміни" }
    }
  } catch (error) {
...
export async function createShiftWithEmployees(formData: FormData, employeeIds: number[]) {
  try {
    const supabase = createServerClient()
    ...
    if (employeeIds.length === 0) {
      return { success: false, error: "Необхідно вибрати хоча б одного працівника" }
    }
    ...
    try {
      ...
      const { data: shiftEmployeesData, error: shiftEmployeesError } = await supabase
        .from("shift_employees")
...
export async function deleteProductCategory(categoryId: number) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при видаленні категорії" }
    }
  } catch (error) {
...
export async function deleteProduct(productId: number) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при видаленні продукту" }
    }
  } catch (error) {
...
export async function deleteShift(shiftId: number) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при видаленні зміни" }
    }
  } catch (error) {
...
export async function updateProduct(formData: FormData) {
  try {
    ...
    const category_id = formData.get("category_id") === "" ? null : Number(formData.get("category_id"))
    const reward = formData.get("reward") === "" ? null : Number(formData.get("reward"))
    ...
    if (!id || !name) {
      return { success: false, error: "Необхідно вказати ID та назву продукту" }
    }
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при оновленні продукту" }
    }
  } catch (error) {
...
export async function createEmployee(formData: FormData) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при створенні працівника" }
    }
  } catch (error) {
...
export async function createProduct(formData: FormData) {
  try {
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при створенні продукту" }
    }
  } catch (error) {
...
export async function removeEmployeeFromShift(shiftId: number, employeeId: number) {
  try {
    const supabase = createServerClient()

    if (!shiftId || !employeeId) {
      return { success: false, error: "Необхідно вказати ID зміни та працівника" }
    }
    ...
    try {
      ...
      return { success: false, error: "Сталася непередбачена помилка при видаленні працівника зі зміни" }
    }
  } catch (error) {
...
export async function getShiftDetails(shiftId: number): Promise<ShiftWithDetails | null> {
  try {
    const supabase = createServerClient()
