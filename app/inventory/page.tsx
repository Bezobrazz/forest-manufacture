...
import { getInventory, getInventoryTransactions, getProducts } from "@/app/actions"
  ...
  return (
    <div className="container py-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Перегляд та управління запасами продукції на складі</p>
      </div>
            ...
            <Card>
              <CardContent className="py-8">
                <div className="text-center">
                  <p className="text-muted-foreground">Немає даних про запаси на складі</p>
                </div>
              </CardContent>
            </Card>
          ) : (
            sortedCategories.map((category) => (
              <Card key={category}>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>Кількість продукції на складі</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    {inventoryByCategory[category].map((item) => (
                      <div key={item.id} className="flex items-center justify-between py-2 border-b last:border-0">
                        ...
                        <Badge variant={item.quantity > 0 ? "default" : "destructive"} className="ml-2">
                          {item.quantity} шт
                        </Badge>
                      </div>
                    ))}
            ...
            <CardContent>
              {transactions.length === 0 ? (
                <div className="text-center py-4">
                  <p className="text-muted-foreground">Немає даних про операції зі складом</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {transactions.map((transaction) => (
                    <div key={transaction.id} className="flex items-start justify-between py-2 border-b last:border-0">
                        ...
                        <div>
                          ...
                          <div className="text-sm">
                            ...
                            <span className="text-muted-foreground">
                              ({transaction.product?.category?.name || "Без категорії"})
                            </span>
                          </div>
                          {transaction.notes && (
                      ...
                      <Badge
                        variant={transaction.quantity > 0 ? "default" : "destructive"}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Ручне коригування кількості продукції на складі</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Відвантаження продукції зі складу</CardDescription>
              </CardHeader>
              <CardContent>
